...
return [
    ...
    */
    ...
    |
    */
    'logo' => '<img src="/logo.png" width="100%" style="max-width: 100% !important;">',
    ...
    |
    */
    'logo-mini' => '<img src="/logo.png" width="100%" style="max-width: 100% !important;">',
   ...
   */
    ...
    */
    'database' => [
        ...
        'permissions_model' => UserPermission::class,

        // Menu table and model.
        'menu_table' => 'user_menus',
        'menu_model' => UserMenu::class,

        // Pivot table for table above.
        'role_users_table'       => 'user_role_users',
        'role_permissions_table' => 'user_role_permissions',
        'role_menu_table'        => 'user_role_menus',
        'permission_menu_table'  => 'user_permission_menus',
