  ...
  actions: {
    async login(
      ...
      try {
        ...
        const returnUrl = localStorage.getItem('cloud-ref');
        if (returnUrl) {
          localStorage.removeItem('cloud-ref');
    ...
    async register(
      ...
      // call user show to register user on vpn
      const userStore = useUserStore();
      await userStore.fetchUser();
    ...
    logout() {
      ...
      localStorage.removeItem('cloud-user_share_id');
    ...
    updateUser(user) {
      ...
      localStorage.removeItem('cloud-user');
      localStorage.setItem('cloud-user', JSON.stringify(user));
    },
  }
});
