...
const userOrder = computed(() => store.state.userOrderHistory.withdrawUserOrder);
</script>
<template>
  <div id="menu-withdrawal-detail" class="offcanvas offcanvas-bottom offcanvas-detached rounded-m">
      ...
      >
        <a href="#" class="d-flex py-1 pb-4">
          ...
          <div class="align-self-center ps-1">
            <h5 class="pt-1 mb-n1">{{ t('asset.withdrawal.name') }}</h5>
