...
const userOrder = computed(() => store.state.userOrderHistory.depositUserOrder);
</script>
<template>
  <div id="menu-deposit-detail" class="offcanvas offcanvas-bottom offcanvas-detached rounded-m">
      ...
      >
        <a href="#" class="d-flex py-1 pb-4">
          ...
          <div class="align-self-center ps-1">
            <h5 class="pt-1 mb-n1">{{ t('asset.deposit.name') }}</h5>
