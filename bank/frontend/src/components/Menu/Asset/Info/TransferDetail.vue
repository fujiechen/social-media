...
const userOrder = computed(() => store.state.userOrderHistory.transferUserOrder);
</script>
<template>
  <div id="menu-transfer-detail" class="offcanvas offcanvas-bottom offcanvas-detached rounded-m">
    <!-- menu-size will be the dimension of your menu. If you set it to smaller than your content it will scroll-->
    <div class="menu-size" style="height:430px;">
      <div
      ...
      >
        <a href="#" class="d-flex py-1 pb-4">
          ...
          <div class="align-self-center ps-1">
            <h5 class="pt-1 mb-n1">{{ t('asset.transfer.name') }}</h5>
        ...
        <div class="row">
          ...
          <template v-if="userOrder.to_user">
            <strong class="col-5 color-theme">收款人姓名</strong>
            <strong class="col-7 text-end">{{ userOrder.to_user.name }}</strong>
            <div class="col-12 mt-2 mb-2">
              <div class="divider my-0"></div>
            </div>
            <strong class="col-5 color-theme">收款人邮箱</strong>
            <strong class="col-7 text-end">{{ userOrder.to_user.email }}</strong>
            <div class="col-12 mt-2 mb-2">
              <div class="divider my-0"></div>
            </div>
          </template>
