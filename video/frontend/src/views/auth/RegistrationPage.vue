...
const userShareIdFromLocal = localStorage.getItem('video-user_share_id');
  ...
  <van-form @submit="register">
    <van-space direction="vertical" fill>
      ...
      <van-row justify="center">
        <p>
          已经拥有账户?
          <router-link :to="{name:'login'}" style="color: var(--van-primary-color) !important;">登录</router-link>
        </p>
      </van-row>
